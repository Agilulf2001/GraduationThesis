...
javac JAVA_SIM/SimulationEx.java -cp .:/home/agi/Dune/simulation/argparse4j-0.8.1.jar:/home/agi/Dune/simulation/log4j-1.2.17.jar
echo Manifest-Version: 1.0 > manifest
echo Created-By: 11.0.7 \(Ubuntu\) >> manifest
echo Main-Class: JAVA_SIM.SimulationEx >> manifest
