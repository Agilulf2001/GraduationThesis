...
public abstract class SuMaxSketch {
    ...
    protected int SUMAX_ARRAY_LENGTH; // 2^ArrayLengthBit
    ...
    private void initCellUsableArray(double theda)
    {
        ...
        isUsingTheda = true;
        List<Integer> usableIndicators = Util.getRandomList(this.SUMAX_ARRAY_LENGTH, (int)(theda * this.SUMAX_ARRAY_LENGTH), 0);
    ...
    public void Insert(Packet packet, TelemetryData data) {
        // set this sketch's hashIndex[] by packet's flowID's hashes
        setHashIndexByPacketID(packet.getFlowID());
        // Increase the corresponding sizeCellArray[][] by 1
